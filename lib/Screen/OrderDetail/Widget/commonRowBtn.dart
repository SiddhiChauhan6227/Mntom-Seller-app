...
class CommonRowBtnPng extends StatelessWidget {
  final String title;
  final VoidCallback onBtnSelected;

  const CommonRowBtnPng({Key? key, required this.title, required this.onBtnSelected})
      : super(key: key);
  ...
  Widget _buildBtnAnimation(BuildContext context) {
    return InkWell(
      child: Container(
        ...
        padding: const EdgeInsets.all(7),
        child: Image.asset(
          DesignConfiguration.setPngPath(title),
          alignment: Alignment.center,
          height: 30,
          width: 30,
          fit: BoxFit.cover,
